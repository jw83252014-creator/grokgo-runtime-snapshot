...
- `topics/` - topic maps and convergence clusters.
- `people/` - public cards for key accounts and researchers.
- `sources/` - source summaries with URLs and dates.
